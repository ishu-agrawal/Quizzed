...
<body>
    <div class="navbar">
        <ul class="nav-list">
            <div class="logo"><img src="img/logoo.jpeg" onclick="window.location.href = 'account.php';" alt="logo"></div>
    ...
    <section class="background firstSectionindex">
        ...
        <div class="card">
            ...
            <h3 class="card header"> Welcome
                ...
                ?>
                You have To select only one option out of 4. Best of luck!
            </h3>
        </div><br>
        <div class="fullcard">
    ...
    <footer>
        <p class="text-footer">
        Copyright &copy; 2022 - www.quizzed.com All rights resreved
        </p>
    </footer>
</body>
